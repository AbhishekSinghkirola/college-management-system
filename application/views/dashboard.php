...
<div class="row mb-4 g-6">
    ...
    <div class="col-12 col-xl-4 col-md-6">
      <div class="card h-100">
        <div class="card-body">
          <div class="bg-label-primary rounded-3 text-center mb-4 pt-5">
            <img class="img-fluid" src="<?= base_url()?>cms-assets/assets/img/sitting-girl-with-laptop.png" alt="Card girl image" style="width: 52%;">
          </div>
